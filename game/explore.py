...
XP, Berrys, objets, potentiellement trouver un Poneglyphe, ou tomber sur
une rencontre hostile (Marine, pirate rival, monstre marin...).
"""
import random

from . import data, world, progression, enemies
